...
const expectedCollection = [path.resolve("content/adventures/wizard-art.json")];
...
if (!jobs || jobs.collectionFiles !== 1) problems.push("generation route does not trace the nine-board collection hash manifest");
