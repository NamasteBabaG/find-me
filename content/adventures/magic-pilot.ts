...
const plans: { draft: typeof castle; name: ReturnType<typeof t>; wardrobe: string; light: string; spots: Spot[] }[] = [
  { draft: castle, name: t("שער הטירה", "Castle courtyard"),
    ...
    spots: [
      { crop: [680, 300], mask: [115, 90, 220, 360], pose: "standing", height: 360,
      ...
      { crop: [2360, 340], mask: [115, 140, 235, 390], pose: "standing", height: 390,
      ...
      { crop: [1800, 1300], mask: [130, 200, 255, 460], pose: "kneeling", height: 430,
        hint: t("חפשו ליד האביר שעוזר עם המגן", "Look beside the knight helping with the shield."),
        support: "Replace the kneeling child beside the seated knight, with knees supported on the paving at the same depth.", occlusion: "Keep the shield and knight's hands in front where they already occlude the child. No feet through the wooden step or shield." },
    ] },
  { draft: library, name: t("ספריית הענק", "The giant library"),
    ...
    spots: [
      { crop: [1450, 470], mask: [165, 290, 190, 230], pose: "sitting-cross-legged", height: 360,
      ...
      { crop: [1820, 900], mask: [225, 205, 225, 330], pose: "sitting-cross-legged", height: 390,
      ...
      { crop: [720, 1350], mask: [100, 110, 285, 425], pose: "peeking", height: 450,
        hint: t("חפשו מאחורי ספר הצמחים הפתוח", "Look behind the open book about plants."),
        support: "Replace the curly-haired reader in purple at the foreground botanical-book table, keeping the same supported seated torso and book-reading action.", occlusion: "The desk and open botanical book remain IN FRONT of the child's lower body. Do not paint feet or knees over the tabletop." },
    ] },
  { draft: forest, name: t("יער הפיות", "Fairy forest"),
    ...
    spots: [
      { crop: [610, 210], mask: [150, 85, 240, 410], pose: "sitting-cross-legged", height: 390,
        hint: t("חפשו ליד העץ עם הפנים המחייכות", "Look beside the tree with the friendly face."),
        support: "Replace the green-clad child sitting on the tree-root ledge by the friendly tree and flying blue fairy. Keep the same ledge-supported seated body.", occlusion: "Preserve the tree face, fairy and root ledge. The child's face is turned three-quarter toward the viewer, not hidden in the tree." },
      { crop: [3030, 285], mask: [35, 150, 220, 410], pose: "kneeling", height: 400,
      ...
      { crop: [2240, 1390], mask: [50, 305, 245, 260], pose: "peeking", height: 400,
