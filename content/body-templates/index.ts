...
export const BODY_TEMPLATES: Record<string, BodyTemplate> = {
  ...
  giantlibrary_doorway: { id: "giantlibrary_doorway", label: t("in the doorway", "בפתח הדלת"), pose: "peeking", accessory: { glyph: "", place: "none" }, outfit: { primary: "#6B4FA8", secondary: "#FFF8EC" } },
