...
- Rendering remains MEDIUM, 768×1152, opaque. LOW reasoning is a different setting: identity review and grouped board review use GPT-5.6 Luna LOW. No silent high-cost fallback is introduced.
...
Historical comparison: Omer (`game_mruqsdt9sccz4n2im09r`) was recorded in the preceding release report at **USD2.776271, 82 settled operations, 27 hides**. That is a usage/rate-card estimate, not a verified provider invoice, and excludes development/R&D, infrastructure, email and payment fees. Target for the new 45-hide world is USD2–2.50; USD1.50 remains an unproven stretch target. Neither token-rate savings nor synthetic tests prove the actual whole-world price.
