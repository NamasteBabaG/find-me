...
/**
 * The card grid that came before the illustrated map.
 *
 * Kept as the fallback for a game composed before worlds existed: its config
 * has boards but no journey, so there is no map to draw.
 */
export function IslandGrid({ config, progress, onOpen, onPassport, demo }: Props) {
