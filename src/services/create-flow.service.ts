...
import { LOCAL_PATCH_FIVE_SCENE_VERSION } from "../domain/scene/local-patch-catalog";
...
async function replaceScenes(c: Container, gameId: string, slugs: string[]): Promise<void> {
  ...
  const version = game.styleVersion === LOCAL_PATCH_STYLE ? LOCAL_PATCH_FIVE_SCENE_VERSION : undefined;
