import { auditWorldBudget, WorldBudget, WorldBudgetError, type WorldBudgetRepository, type WorldReservationInput, type WorldChargeEvidence } from "./world-budget";
...
export function boardWizardBudget(repository: WorldBudgetRepository, attempt = 1) {
  ...
  return new AttemptBudget(guarded);
}
